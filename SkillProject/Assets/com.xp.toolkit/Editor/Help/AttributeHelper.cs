...
namespace XPToolchains.Help
{
    ...
    public static partial class AttributeHelper
    {
        ...
        public static bool TryGetFieldAttribute<AttributeType>(Type _type, string _fieldName,
            ...
            where AttributeType : Attribute
        {
            return TryGetFieldInfoAttribute(ReflectionHelper.GetFieldInfo(_type, _fieldName), out _attribute);
        }

        /// <summary> 
        /// 根据<paramref name="_fieldInfo"/>获取所有特性 
        /// </summary>
        ...
        public static bool TryGetFieldAttributes(Type _type, string _fieldName,
            out Attribute[] _attributes)
        {
            return TryGetFieldInfoAttributes(ReflectionHelper.GetFieldInfo(_type, _fieldName), out _attributes);
        }
        ...
        public static bool TryGetMethodAttribute<AttributeType>(Type _type, string _methodName,
            ...
            where AttributeType : Attribute
        {
            return TryGetMethodInfoAttribute(ReflectionHelper.GetMethodInfo(_type, _methodName), out _attribute);
        }

        /// <summary> 
        /// 根据<paramref name="_methodInfo"/>获取所有特性
        /// </summary>
        ...
        public static bool TryGetMethodAttributes(Type _type, string _methodName,
            out Attribute[] _attributes)
        {
            return TryGetMethodInfoAttributes(ReflectionHelper.GetMethodInfo(_type, _methodName), out _attributes);
        }
